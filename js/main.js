$(function () {
    ...
    const slider = $('.products-slider__items').slick({
        ...
        slidesToShow: 6,
        infinite: true,
        prevArrow: "<button id='prev' type='button' class='banner-section__slider slider-btnprev'><span></span></button>",
        nextArrow: '<button id="next" type="button" class="banner-section__slider slider-btnnext"><span></span></button>'
    });
    ...
    $('.spotlight-slider__items').slick({
        ...
        slidesToShow: 5,
        infinite: true,
        prevArrow: '<button id="prev" type="button" class="spotlight__slider spotlight__slider-btnprev"><span></span></button>',
        nextArrow: '<button id="next" type="button" class="spotlight__slider spotlight__slider-btnnext"><span></span></button>'
    });
